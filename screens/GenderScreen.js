      ...
      <View style={layoutContainer}>
        ...
        <View style={styles.dateContainer}>
          ...
          <Text style={styles.infoDescription}>
            Users are matched based on gender. You can add more details about your gender identity in your profile.
          </Text>
          <View style={styles.genderContainer}>
            <View style={styles.genderOption}>
              ...
              <View style={styles.radioButton} onTouchEnd={() => setSelectedGender('male')}>
            ...
            <View style={styles.genderOption}>
              ...
              <View style={styles.radioButton} onTouchEnd={() => setSelectedGender('female')}>
            ...
            <View style={styles.genderOption}>
              ...
              <View style={styles.radioButton} onTouchEnd={() => setSelectedGender('non-binary')}>
